...
const InputField: FC<Props> = ({
  ...
  errorMsg,
  disabled = false,
  className = 'bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:outline-none focus:ring-1 focus:border-primary-600 block w-full p-2.5',
  id,
  options,
  height,
  width,
